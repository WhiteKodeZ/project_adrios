...
<body>
    ...
    <div class="boxed_wrapper">
        ...
        <div class="row">
                    ...
                    <div class="auto-container">
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-sm-12 content-column">
                                <h2
                                    style="color: #03052F;font-family: Outfit;font-size: 30px;font-style: normal;font-weight: 600;line-height: normal;">
                                    Contact Us</h2>
                                <p style="color: #03052F;font-family: Outfit;font-style: normal;line-height: normal;">We
                                    are more than excited to hear from you. Get in touch</p>
                                <div style="margin-top: 20px;" class="content-inner">
                                    <div class="image-box">
                                        <div class="row clearfix">
                                                    ...
                                                    <div class="row clearfix">
                                                        ...
                                                        <div style="margin-top:45px;"
                                                            ...
                                                            <button
                                                                ...
                                                                type="submit">
                                                                <p
                                                                    style="color: white; font-size: 18px; font-family: Outfit; font-weight: 500; word-wrap: break-word">Procced
                                                                </p>
                                                            </button>
                                                        </div>
                                                    </div>
            ...
            <div style="background: url('/assets/img/contactUs_img.png');background-size: cover; background-repeat: no-repeat; height:570px;"
